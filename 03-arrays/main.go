...
func main() {
	// Un vector ya tiene un tamaño fijo
	var myIntVar int
	...
	// Un slice no tiene un tamaño fijo y cambia su tamaño dinámicamente en tiempo de ejecución
	var slice1 []int
	...
	mySlice := myArrayVar[2:4] // del indice 2 hasta el indice 4
	fmt.Println(mySlice)
